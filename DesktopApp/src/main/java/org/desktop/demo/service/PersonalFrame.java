...
class PersonalFrame extends JFrame {
    ...
    public PersonalFrame() {
 	   ...
 	   System.out.println("Error occured in instantiating the Personal frames");
    }
    }

    public String PersonalExpensesDisplay() throws IOException
    {
        Response personalExpenses = null;
        try {
        ...
        String rw_body = personalExpenses.body().string();
